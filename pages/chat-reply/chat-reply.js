  ...
  stranger_first: {
    male: {
      default: [
        ...
        { style: '共同话题法', text: '我发现你也在看这个展，你觉得哪一件作品最有意思？', explain: '用共同场景制造自然连接，话题有共同基础' },
        { style: '帮忙式开口', text: '你好，附近哪里停车比较方便？顺便问一下你在这里等人吗？', explain: '用小帮助或求助打开对话，压力极低' },
      ],
      happy: [{ style: '接话延伸', text: '你今天心情不错嘛，有什么好事可以分享吗？', explain: '顺着对方情绪延伸，自然邀请分享' }],
      cold: [
        { style: '低压力破冰', text: '不打扰你，就是随口问一下……（问一个无害的小问题）', explain: '对方表现冷淡时，降低压力感更有效' },
        { style: '坦诚退路式', text: '我知道这样搭话有点突然，但我真的觉得你很特别，不方便的话当我没说', explain: '坦诚承认搭讪+留退路，反而降低对方防备' },
      ],
      invite: [
        { style: '顺势要联系方式', text: '跟你聊了一会儿，感觉你很有意思，有没有微信？改天我们多聊聊', explain: '聊得来的时候自然过渡，不要突然问' },
        { style: '价值交换式', text: '你说你也喜欢这类展览，我这边有个关注的号会发消息，要不要加个微信，我发给你？', explain: '给出加微信的具体理由，对方有获得感' },
      ],
      warm_up: [
        { style: '记住细节再接话', text: '你刚才说你最近在学（某个东西），我也有点好奇，你是怎么开始学的？', explain: '记住对方随口说的事，然后认真追问，对方会感受到被重视' },
      ],
    },
    female: {
      default: [
        ...
        { style: '半接话式', text: '是吗，我没听说过这个……但感觉挺有意思的，你怎么知道这些的？', explain: '表现好奇但不过分，引他多说' },
        { style: '轻松反问式', text: '你这个人感觉挺有意思的，平时都喜欢干什么？', explain: '直接问兴趣，轻松自然，给他展示的机会' },
      ],
      warm_up: [
        { style: '接收信号式', text: '（他主动说话后）你说的这个，我之前也有点了解，下次可以聊聊', explain: '接受他的话题，同时给出"下次"的信号' },
      ],
    },
  },
  ambiguous_invite: {
